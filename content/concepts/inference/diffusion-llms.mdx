...
2. **Treating diffusion as a frontier-quality replacement.** The gap on knowledge-heavy and long-chain reasoning tasks is real and, as of 2026, no diffusion model plays at the frontier on those axes.
