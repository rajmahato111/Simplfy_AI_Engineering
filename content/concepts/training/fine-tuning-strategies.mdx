...
**The run.** 2,150 examples for 3 epochs at learning rate 2e-5: (2,000 × 530 tokens/example) × 3 epochs ≈ **3.18M tokens** processed across the whole job — small enough to finish on a single 8-GPU node in a few hours, nowhere near the scale of the pretraining run in the previous chapter.
