...
- **pgvector reality check:** brute-force pgvector is "OK to ~1M vectors" as a rule of thumb — 20 million rows and a 500-way tenant filter is well past what a Postgres extension without a serious ANN index was built for.
