...
diagrams:
  - diagrams/rag-evaluation-patterns--eval-stack.svg
est_minutes: 13
...
![The RAG evaluation stack: pipeline under test on top, golden-set and production judging below](diagrams/rag-evaluation-patterns--eval-stack.svg)
